...
usingnamespace @import("gfx.zig");
const rendering =  @import("rendering.zig");
const common = @import("common_comps.zig");
...
pub const Renderer = struct {
    ...
    pub fn init(alloc: *std.mem.Allocator) !Renderer {
        ...
        return Renderer{
            ...
            .width = width,
            .height = height,
            .cameras = undefined, //ecs.World.allWith([_]type{Camera}),
            .renderables = undefined, //ecs.World.allWith([_]type{Mesh}),
            // TODO:
    ...
    pub fn update(self: *Renderer, delta: f64) bool {
        ...
        //printf("Current size: {}, {}\n", width, height);
        bgfx_set_view_rect(0, 0, 0, @intCast(u16, self.width), @intCast(u16, self.height));
        bgfx_touch(0);

        // The 2 spaces are needed otherwise it somehow has a ghost at the end of the line
        bgfx_dbg_text_printf(0, 0, 0x0f, c"FPS: %.0f  ", 1.0 / delta);
        ...
        return glfwWindowShouldClose(self.window) != GLFW_TRUE;
    }
};
